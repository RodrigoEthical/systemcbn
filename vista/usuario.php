...
<head>
    <meta charset="UTF-8">
    <title>Panel Usuario - Cervecería Boliviana Nacional S.A.</title>
...
<body>
    ...
    <div class="container mt-5">
        <h1>Bienvenido Usuario General</h1>
        <p>Panel para solicitar productos.</p>
        <div class="alert alert-warning">Ruteo correcto para Usuario</div>
    </div>
</body>
</html>